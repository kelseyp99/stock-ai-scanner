...
const FILTERS: { id: FilterId; label: string; icon: string; tip: string }[] = [
  ...
  { id: 'institutional',  label: 'Institutions', icon: '🏦', tip: 'Stocks with institutional ownership changes from configured 13F data. Because 13F filings are delayed, treat this as conviction context rather than a primary signal.' },
